...
PAGES = [
    ...
    ("partners/index.html", "partners.html",
     "Partners",
     "Externe praktijken en platformen waarnaar KennisCentrum Haptonomie verwijst.",
     "partners", "/partners/"),
...
ARTICLES = [
    ("nieuws/casemanager-verzuim-mens-en-proces/index.html",
     ...
     "Ontdek wat werken als casemanager verzuim inhoudt en waarom communicatie, procesbegeleiding en aandacht voor duurzame inzetbaarheid belangrijk zijn.",
     "/nieuws/casemanager-verzuim-mens-en-proces/"),
    ("nieuws/adhd-onderzoek-wanneer-overwegen/index.html",
     "nieuws/adhd-onderzoek-wanneer-overwegen.html",
     "Wanneer is ADHD-onderzoek het overwegen waard?",
     "Herken je langdurig problemen met aandacht, planning of impulsiviteit? Lees wat professionele ADHD-diagnostiek inhoudt en waarom zorgvuldig onderzoek belangrijk is.",
     "/nieuws/adhd-onderzoek-wanneer-overwegen/"),
    ("nieuws/praten-over-mentale-klachten/index.html",
     "nieuws/praten-over-mentale-klachten.html",
     "Online psychologische hulp, wanneer kan het bij je passen?",
     "Wanneer kan psychologische begeleiding helpen? ✓ Lees over mentale klachten ✓ professionele gesprekken ✓ online therapie vanuit huis.",
     "/nieuws/praten-over-mentale-klachten/"),
    ("nieuws/individuele-therapie-ruimte-voor-jezelf/index.html",
     "nieuws/individuele-therapie-ruimte-voor-jezelf.html",
     "Individuele therapie online, ruimte voor jezelf en meer zelfreflectie?",
     "Lees hoe individuele online therapie ruimte biedt voor zelfreflectie, inzicht in patronen en persoonlijke begeleiding vanuit een vertrouwde omgeving.",
     "/nieuws/individuele-therapie-ruimte-voor-jezelf/"),
    ("nieuws/integrative-medicine-visies-op-gezondheid/index.html",
     "nieuws/integrative-medicine-visies-op-gezondheid.html",
     "Integrative medicine Nederland, hoe werkt een brede zorgvisie?",
     "✓ Integrative medicine Nederland uitgelegd ✓ Lees hoe lichaamsbewustzijn en verschillende gezondheidsvisies elkaar kunnen aanvullen.",
     "/nieuws/integrative-medicine-visies-op-gezondheid/"),
